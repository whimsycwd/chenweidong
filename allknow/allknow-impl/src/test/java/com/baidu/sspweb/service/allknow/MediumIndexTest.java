...
public class MediumIndexTest extends AbstractDeliveryIndexTest {
    Logger logger = LoggerFactory.getLogger(MediumIndexTest.class);
    ...
    public MediumIndexTest(String query, int expectedSize) {
        this.query = query;
    ...
    public void testLoadEnv() {
        loadEnv("delivery_5106311_data_medium.txt");
    ...
    @Test
    public void testInsertEnv() throws InterruptedException {
        insertEnv("delivery_5106311_data_medium.txt");
